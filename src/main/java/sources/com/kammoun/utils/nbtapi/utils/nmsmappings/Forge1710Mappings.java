...
public class Forge1710Mappings {
    ...
    public static String toString(Object obj) {
        ...
        try {
            return (String) crucible_toString.invoke(obj, new Object[0]);
        } catch (Exception e) {
            throw new NbtApiException("Error while calling the method 'crucible_toString', from Forge1710Mappings. Passed Class: " + Forge1710Mappings.class, e);
        }
    }
