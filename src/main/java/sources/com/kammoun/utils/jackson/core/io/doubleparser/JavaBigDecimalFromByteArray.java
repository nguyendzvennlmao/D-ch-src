...
final class JavaBigDecimalFromByteArray extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            int i5 = -1;
            int i6 = i;
            byte charAt = charAt(bArr, i6, checkBounds);
            boolean z = false;
            ...
            while (i6 < checkBounds) {
                ...
                if (!FastDoubleSwar.isDigit(charAt)) {
                    ...
                    z |= i5 >= 0;
                    i5 = i6;
                    while (i6 < checkBounds - 4 && (tryToParseFourDigits = FastDoubleSwar.tryToParseFourDigits(bArr, i6 + 1)) >= 0) {
            ...
            return valueOfBigDecimalString(bArr, i7, i5, i5 + 1, i4, z2, (int) j);
    ...
    BigDecimal parseBigDecimalStringWithManyDigits(byte[] bArr, int i, int i2) {
        ...
        int i7 = i + i2;
        int i8 = i;
        byte charAt = charAt(bArr, i8, i7);
        boolean z = false;
        boolean z2 = charAt == 45;
        if (z2 || charAt == 43) {
            i8++;
            charAt = charAt(bArr, i8, i7);
            if (charAt == 0) {
                throw new NumberFormatException(AbstractNumberParser.SYNTAX_ERROR);
            }
        }
        int i9 = i8;
        while (i8 < i7 - 8 && FastDoubleSwar.isEightZeroes(bArr, i8)) {
            i8 += 8;
        }
        while (i8 < i7 && bArr[i8] == 48) {
            i8++;
        }
        int i10 = i8;
        while (i8 < i7 - 8 && FastDoubleSwar.isEightDigits(bArr, i8)) {
            i8 += 8;
        }
        while (i8 < i7) {
            byte b = bArr[i8];
        ...
        if ((charAt | 32) == 101) {
            i4 = i8;
            i8++;
            byte charAt2 = charAt(bArr, i8, i7);
            boolean z3 = charAt2 == 45;
            if (z3 || charAt2 == 43) {
                i8++;
                charAt2 = charAt(bArr, i8, i7);
            }
            z = !FastDoubleSwar.isDigit(charAt2);
            do {
                if (j2 < 2147483647L) {
        ...
        return valueOfBigDecimalString(bArr, i10, i5, i6, i4, z2, (int) j);
    }
    ...
    BigDecimal valueOfBigDecimalString(byte[] bArr, int i, int i2, int i3, int i4, boolean z, int i5) {
        ...
        if (i8 <= 0) {
            ...
            bigInteger = ParseDigitsTaskByteArray.parseDigitsRecursive(bArr, i, i2, navigableMap, 400);
        } else {
            bigInteger = ParseDigitsTaskByteArray.parseDigitsIterative(bArr, i, i2);
        }
        if (i6 > 0) {
            if (i7 > 400) {
                ...
                parseDigitsIterative = ParseDigitsTaskByteArray.parseDigitsRecursive(bArr, i3, i4, navigableMap, 400);
            } else {
                parseDigitsIterative = ParseDigitsTaskByteArray.parseDigitsIterative(bArr, i3, i4);
            }
